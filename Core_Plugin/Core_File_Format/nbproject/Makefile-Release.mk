...
../../${CND_CONF}/libOBJ_model.so: ../../LibExpance_Common/../Release/libexpance_common.a
...
${OBJECTDIR}/OBJModel.o: OBJModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../SharedInclude -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/OBJModel.o OBJModel.cpp
