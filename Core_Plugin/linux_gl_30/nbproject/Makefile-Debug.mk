...
../../${CND_CONF}/libgl_30.so: ../../LibExpance_Common/../Debug/libexpance_common.a
...
${OBJECTDIR}/soil/stb_image_aug.o: soil/stb_image_aug.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -I. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/soil/stb_image_aug.o soil/stb_image_aug.c

${OBJECTDIR}/soil/image_helper.o: soil/image_helper.c 
	${MKDIR} -p ${OBJECTDIR}/soil
	${RM} $@.d
	$(COMPILE.c) -g -I. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/soil/image_helper.o soil/image_helper.c

${OBJECTDIR}/soil/SOIL.o: soil/SOIL.c 
	${MKDIR} -p ${OBJECTDIR}/soil
	${RM} $@.d
	$(COMPILE.c) -g -I. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/soil/SOIL.o soil/SOIL.c

${OBJECTDIR}/soil/image_DXT.o: soil/image_DXT.c 
	${MKDIR} -p ${OBJECTDIR}/soil
	${RM} $@.d
	$(COMPILE.c) -g -I. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/soil/image_DXT.o soil/image_DXT.c

${OBJECTDIR}/opengl_30.o: opengl_30.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -s -I../../SharedInclude -I. -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/opengl_30.o opengl_30.cpp
